...
class WC_MC_Payment_Api  {
    ...
    const ENV_PRO = 'https://test-api.moneycollect.com/api/services/v1';
    const ENV_TEST = 'https://test-sandbox.moneycollect.com/api/services/v1';
    const JSSDK = 'https://test-static.moneycollect.com/jssdk/js/MoneyCollect.js';
    ...
    public static function del_payment_method ($customer_id) {
        $api = self::get_env().'/payment_methods/'.$customer_id.'/detach';
    ...
    protected function request ($data,$api,$method = 'POST') {
        ...
        $logger = new WC_MC_Payment_Logger();
        $logger->payment(['api'=>$api,'data'=>$data]);
